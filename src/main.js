...
function makeRandomPoster(currentPoster) {
  var randomImage = images[getRandom(images)]
  var randomTitle = titles[getRandom(titles)]
  var randomQuote = quotes[getRandom(quotes)]
